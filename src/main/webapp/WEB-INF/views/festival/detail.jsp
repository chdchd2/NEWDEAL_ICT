...
<section>
			...
			<div id="sectionC">
				<div id="subMenu">
					<h2>취업정보게시판</h2>
					<ul>
						<li><a href="<c:url value='/festival/list'/>" class="subActive">정보안내 <img src="<c:url value='/resources/images/submenu_Active.png'/>" alt="서브메뉴활성화알림버튼"></a></li>
						<li><a href="<c:url value='/festival/detailList'/>">행사안내</a></li>
						<li><a href="#">프로그램</a></li>
					</ul>
				</div>
				...
				<div id="sectionR">
					...
					<div id="content">
						...
						<div id="board">
						 ...
						 <a id="list" href="<c:url value='/festival/fesEdit?fesNum=${FestivalVo.fesNum }'/>">수정</a>
   ...
   파일목록 : <c:forEach var="list" items="${FestivalVo.list }"><a href="<c:url value='/edu/fileDown?fileNum=${list.fileNum }'/>">${list.fileOrgName }</a><br></c:forEach>
 

</body>

  
   파일목록 : <c:forEach var="list" items="${FestivalVo.list }"><a href="<c:url value='/festival/fileDown?fileNum=${list.fileNum }'/>">${list.fileOrgName }</a><br></c:forEach>
