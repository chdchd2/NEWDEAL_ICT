...
$(function(){
	...
	$(".btnList").click(function(){
		...
		//document.form.submit(); */
		document.form.action="<c:url value='/festival/detailList'/>";
		document.form.submit();
	});
});
</script>
...
<form id="form" name="form" method="post" enctype="multipart/form-data" action="<c:url value='/festival/write'/>">
<div id="content">
<table>
							<colgroup>
								<col>
							...
							<tbody>
								<tr>
									<td>제목</td>
									<td>
										 <input type="text" name="detTitle" id="title">
									</td>
								</tr>
								<tr>
									<td>작성자</td>
									<td><input type="text" id="writer" name="detWriter" value="${member.memNickName }">
								...
								<tr>
									<td>내용</td>
									<td><textarea name="Content" id="detContent" cols="30" rows="10"></textarea>
									</td>
								</tr>
							</tbody>
						</table>
