...
<link rel="stylesheet" href="<c:url value='/resources/css/signin.css?ver=1'/>">
<div id="signinDiv">
			<div>
				<h1 id="signin">
					<span>뉴딜 일자리</span> 회원가입
				</h1>
				<br>
				<br>
				<p id="explain">
				...
				<br>
					<b style="font-size: 19px;line-height: 24px;">회원종류 선택</b><br><br>
    ...
    color: #000;
				...
				<br>
				<p id="lower" style="font-size: 14px;line-height: 24px;">
