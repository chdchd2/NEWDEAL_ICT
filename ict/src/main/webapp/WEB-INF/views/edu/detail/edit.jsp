...
$(function(){
   ...
   $(".btnUpdete").click(function(){
      ...
      //폼에 hidden 태그들을 추가
      $("#form").append(str);
      document.form1.action="<c:url value='/edu/detEdit'/>"; 
   ...
   $(".btnList").click(function(){
      ...
      document.form1.action="<c:url value='/edu/detList'/>";
      document.form1.submit();
   });
});
...
<form id="form1" name="form1" action="<c:url value='/edu/detEdit'/>" method="POST" enctype="multipart/form-data">
<div id="content">
<table>
